export default function Logo({ light = false, size = 'md' }) {
  ...
  return (
    <div className="flex items-center gap-2.5">
      <div className={`${box} rounded-lg bg-emerald-400 flex items-center justify-center flex-shrink-0`}>
        <svg viewBox="0 0 24 24" className="w-[60%] h-[60%]" fill="none" stroke="#0a0a0a" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round">
